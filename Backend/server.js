...
app.use(cors());
app.use(cors({
    origin: ['http://13.60.225.128:3103', 'http://127.0.0.1:5501'],
    ...
    .then(() => {
        ...
        initializeDatabase().then(() => {
           app.listen(port, '0.0.0.0', () => {
                ...
                console.log(`Health check: http://13.60.225.128:${port}/health`);
                console.log(`HR Dashboard: http://13.60.225.128:${port}/attendance.html`);
                console.log(`Employee Asset Request: http://13.60.225.128:${port}/employee.html`);
            });
        });
    })
    .catch(err => {
